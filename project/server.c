...
void read_index_matrix(int server_index, int mat[5][5]);
...
int main(int argc, char *argv[]) {
  ...
  read_index_matrix(atoi(server_index), index_matrix);
...
void write_index_matrix(int server_index, int mat[5][5]) {
